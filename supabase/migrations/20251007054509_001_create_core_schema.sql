/*
  ...
  ### User Companies (junction for multi-tenancy)
  - `id` (uuid, primary key)
  - `user_id` (uuid) - Reference to auth.users
  - `company_id` (uuid) - Reference to companies
  - `role` (text) - User role in company
  - `created_at` (timestamptz)

  ### Customers, Products, Orders, etc.
  - See full schema details in SQL
...
-- User Companies (junction table for multi-tenancy) - CREATE BEFORE RLS POLICIES
